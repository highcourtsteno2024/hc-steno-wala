...
async function handleAudioUpload(event) {
    ...
    try {
        ...
        statusEl.innerHTML = '<span style="color:var(--success)">✅ Audio uploaded successfully! URL saved.</span>';
        showToast("Audio uploaded", "success");
    } catch (error) {
        console.error(error);
        statusEl.innerHTML = '<span style="color:var(--error)">❌ Error uploading audio. Please ensure Firebase Storage is enabled in Test Mode.</span>';
